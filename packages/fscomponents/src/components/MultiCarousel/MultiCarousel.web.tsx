      ...
      >
        ...
        {this.state.currentIndex !== 0 &&
          !!this.props.showArrow && (
            <TouchableOpacity accessibilityRole='button' accessibilityLabel={'Show previous'} style={S.goToPrev} onPress={this.goToPrev}>
        ...
        {this.state.currentIndex !== pageNum - 1 &&
          !!this.props.showArrow && (
            <TouchableOpacity accessibilityRole='button' accessibilityLabel={'Show next'} style={S.goToNext} onPress={this.goToNext}>
